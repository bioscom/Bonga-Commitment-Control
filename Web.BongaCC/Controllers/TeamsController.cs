...
namespace Web.BongaCC.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public TeamsController(BongaCCDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TeamName,ID")] Team team)
        {
            ...
            {
                team.AddedDate = DateTime.Now.Date;
                team.ModifiedDate = DateTime.Now.Date;
                _context.Add(team);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long? id, [Bind("TeamName,ID,AddedDate,ModifiedDate")] Team team)
        {
            if (id != team.ID)
            {
                return NotFound();
